...
//         selectedFilters.price.max < priceRange.max)
//     ) {
...
//         setSelectedBrand(router.query.brand as string);
//       }

//       if (router.query.minPrice || router.query.maxPrice) {
//         const min = router.query.minPrice
//           ? parseInt(router.query.minPrice as string)
//           : 0;
//         const max = router.query.maxPrice
//           ? parseInt(router.query.maxPrice as string)
//           : priceRange.max;
