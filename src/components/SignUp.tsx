      ...
      <div className="flex flex-col w-full md:w-1/2 p-8">
        <div className="flex items-center mb-8 md:hidden">
          <Image
            ...
            className="mr-2"
          />
          <h1 className="text-xl font-bold text-teal-700">Tareeq-Ul-Shifa Pharmacy</h1>
        </div>
        ...
        <div className="flex-grow flex flex-col justify-center items-center max-w-md mx-auto w-full">
          <div className="relative w-full mb-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 relative">Welcome</h2>
            <p className="text-gray-600 mt-2 relative">Create your account to get started</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-5">
            ...
            <p className="text-center text-gray-600 mt-6">
              ...
              <span className="text-teal-600 font-medium cursor-pointer hover:underline">Sign In</span>
            </p>
          </form>
        </div>
      </div>
