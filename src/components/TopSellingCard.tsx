  ...
  return (
    ...
    >
      <div className="relative group ">
        ...
        <h3 className="text-base mt-3 p-2">{product.name}</h3>
        <p className="text-textColor text-sm p-2">{product.type}</p>
        <div className="mt-1 p-2">
          ...
          <span className="text-normalGreen font-semibold text-lg ml-2 p-2">
            Rs {product.price}
          </span>
        </div>
      </div>
