...
const BrandForm: React.FC<BrandFormProps> = ({ brandToEdit, onSuccess }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      website: brandToEdit?.website || null,
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        />
        <div className="mt-4">
          <label className="text-sm font-robotoSlab py-1 block">Status</label>
          <select
            {...register('status')}
